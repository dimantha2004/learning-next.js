...
export default function EditPostPage() {
  ...
  useEffect(() => {
    ...
    if (foundPost) {
      ...
      setVisibility(foundPost.visibility);
    }
  }, [params.id, getPost]);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <Link href={`/posts/${post.id}`} className="inline-flex items-center space-x-2 text-blue-600 hover:text-blue-700 transition-colors mb-4">
